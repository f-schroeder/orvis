...
It is usually located in [vcpkg-root]/scripts/buildsystems/","Orvis",0)

$vcpkgpath = Get-FileName
if($vcpkgpath -eq ""){
    [System.Windows.Forms.MessageBox]::Show("Error setting the path.","Orvis",0)
    Exit
}
...
[System.Reflection.Assembly]::LoadWithPartialName("System.windows.forms") | Out-Null
[System.Windows.Forms.MessageBox]::Show("Finished setting vcpkg path in CMakeSettings.json","Orvis",0)
